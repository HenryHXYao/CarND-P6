...
/**
 * Computes the multi-gaussian probability
 * @param sig_x, sig_y standard deviation of x and y
 * @param (x_obs,y_obs) observation of the landmark
 * @param (mu_x, mu_y) ground truth of the landmark
 * @output multi-gaussian probability 
 */
